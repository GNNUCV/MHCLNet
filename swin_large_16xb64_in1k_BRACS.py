...
test_dataloader = dict(
    ...
    dataset=dict(
        data_prefix='/home/bsj/dataset/BRACS_RoI_Normalized_512png2/test',  # change
        with_label=True,
        pipeline=[
...
train_dataloader = dict(
    ...
    collate_fn=dict(type='default_collate'),
    dataset=dict(
        data_prefix='/home/bsj/dataset/BRACS_RoI_Normalized_512png2/train',  # change
        with_label=True,
        pipeline=[
            dict(type='mmpretrain.datasets.LoadImageFromFile'),
            dict(
...
val_dataloader = dict(
    ...
    collate_fn=dict(type='default_collate'),
    dataset=dict(
        data_prefix='/home/bsj/dataset/BRACS_RoI_Normalized_512png2/val',  # change
        with_label=True,
        pipeline=[
            dict(type='mmpretrain.datasets.LoadImageFromFile'),
            dict(
