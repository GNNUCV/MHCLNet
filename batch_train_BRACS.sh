...
PORT=29895 bash ./tools/dist_train.sh ./swin_large_16xb64_in1k_BRACS.py 1 --work-dir /home/bsj/swinTransformer_result/Second/bracs/D


export CUBLAS_WORKSPACE_CONFIG=:4096:8
CONFIG="./swin_large_16xb64_in1k_BRACS.py"
CHECKPOINT_DIR="/home/bsj/swinTransformer_result/Second/bracs/D"
...
for CKPT_PATH in $(find $CHECKPOINT_DIR -name "epoch_*.pth" | sort -V); do
    ...
    RESULT=$(PORT=29696 bash /home/bsj/code/mmpretrain-main/tools/dist_test.sh $CONFIG $CKPT_PATH $GPUS \
